    ...
    Widget _getDoc(String img, String name, String desig){
      return Card(
        ...
        child: Container(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(vertical: _mediaQuery.height*0.02, horizontal: _mediaQuery.width*0.05),
            child: Row(
              children: [
                Container(
                  height:_mediaQuery.height*0.13,
                  width:_mediaQuery.height*0.13,
                ...
                SizedBox(width: _mediaQuery.width*0.05,),
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AutoSizeText(name, style: GoogleFonts.roboto(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 18),maxLines: 1,),
                    SizedBox(height:_mediaQuery.height*0.005,),
                    AutoSizeText(desig,style: GoogleFonts.roboto(color: Colors.black87, fontWeight: FontWeight.w400, fontSize: 14),maxLines: 1,),
                  ],
                ),
              ],
            ),
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          AutoSizeText("Our Governing Board", style: GoogleFonts.roboto(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w500, fontSize: 30,),maxLines: 1,),
          SizedBox(height: _mediaQuery.height*0.05,),
          Column(
